package com.fullstack.clinica.user.model;
...
@Data
@Entity
@Table(name = "USERC", uniqueConstraints = {
...
public class User {
    ...
    @Pattern(regexp = "ADMIN|TECNICO|PACIENTE", message = "Rol inválido. Solo se permite ADMIN, TECNICO o PACIENTE")
    @Column(nullable = false, length = 20)
    private String rol;

    // Cada rol TECNICO puede estar asociado a un laboratorio
    @ManyToOne
